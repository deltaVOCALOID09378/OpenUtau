...
// Version: v.1.1
// History/Summary: Widened vcLength to 120 to match CVVC and English/French/Spanish standards for clearer consonant articulation.
        ...
        public override Result Process(Note[] notes, Note? prev, Note? next, Note? prevNeighbour, Note? nextNeighbour, Note[] prevNeighbours) {
            ...
            if (currentHangeul) {
                ...
                if (TCLfinal == "") {
                    ...
                    if ((VC != "") && (TNLconsonant != "")) {
                        int vcLength = 120;
                        if ((TNLconsonant == "r") || (TNLconsonant == "h")) { vcLength = 60; } else if (TNLconsonant == "s") { vcLength = totalDuration / 3; } else if ((TNLconsonant == "k") || (TNLconsonant == "t") || (TNLconsonant == "p") || (TNLconsonant == "ch")) { vcLength = totalDuration / 2; } else if ((TNLconsonant == "gg") || (TNLconsonant == "dd") || (TNLconsonant == "bb") || (TNLconsonant == "ss") || (TNLconsonant == "jj")) { vcLength = totalDuration / 2; }
