...
namespace OpenUtau.App.Views
{
    ...
    class PartMarqueeOverrideEditState : PartEditState
    {
        const double DragThresholdSquared = 16;
        readonly Rectangle selectionBox;
        readonly UPart? clickPart;
        PartSelectionEditState? marqueeState;

        public PartMarqueeOverrideEditState(
            Control control,
            MainWindowViewModel vm,
            Rectangle selectionBox,
            UPart? clickPart) : base(control, vm)
        {
            this.selectionBox = selectionBox;
        ...
        public override void Update(IPointer pointer, Point point)
        {
            ...
            marqueeState = new PartSelectionEditState(control, vm, selectionBox);
        ...
        public override void End(IPointer pointer, Point point)
        {
            ...
            if (clickPart != null)
            {
                vm.TracksViewModel.ToggleSelectPart(clickPart);
            }
        }
    }
